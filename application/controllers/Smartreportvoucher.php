  ...
  function dashboard(){
    ...
    if($check_permission->num_rows() == 1){
        ...
        */
        ...
        $page_data['page_name'] = 'dashboard_voucher';
        ...
        $page_data['lang_dashboard_voucher'] = $this->lang->line('dashboard_voucher');
        $page_data['lang_voucher_created'] = $this->lang->line('voucher_created');
        $page_data['lang_voucher_lock'] = $this->lang->line('voucher_lock');
        $page_data['lang_voucher_redeem'] = $this->lang->line('voucher_redeem');
