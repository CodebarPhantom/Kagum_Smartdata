...
class smartreport_departement_model extends CI_Model
{
    ...
    function deleteDataDepartement($iddept)
    {
        ...
        $this->db->delete('smartreport_dept');
    }

}

/* End of file smartreport_dept_model.php */
/* Location: ./application/models/smartreport_dept_model.php */
