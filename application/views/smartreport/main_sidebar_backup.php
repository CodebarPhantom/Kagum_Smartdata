        ...
        <ul class="nav nav-sidebar" data-nav-type="accordion">
            ...
            <li class="nav-item nav-item-submenu <?php if ($tk_m == 'list_slider' || $tk_m == 'add_slider' || $tk_m == 'update_slider') { ?><?php echo 'nav-item-open'; } else { echo '';} ?>">
                ...
                <ul class="nav nav-group-sub" data-submenu-title="Layouts" <?php if ($tk_m == 'list_slider' || $tk_m == 'add_slider' || $tk_m == 'update_slider') { ?>  <?php echo 'style="display: block;"'; } else { echo 'style="display: none;"';} ?> >
                    ...
                    <li class="nav-item"><a href="<?=base_url()?>rolespermissions/roles" class="nav-link "><i class="icon-images3"></i>Roles</a></li>
                    <li class="nav-item"><a href="<?=base_url()?>rolespermissions/permissions" class="nav-link "><i class="icon-images3"></i>Permissions</a></li> 
                    <li class="nav-item"><a href="<?=base_url()?>rolespermissions/permissions-group" class="nav-link "><i class="icon-images3"></i>Permissions Group</a></li>                    
                </ul>
            </li>
            <?php } ?>
