		...
		<!-- /page header -->                
				...
				<div class="card">
					...
					<div class="form-group row">
						<div class="col-lg-3">
							<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left" data-toggle="modal" data-target="#modal_add_permissions_group"><b><i class="icon-grid6"></i></b> <?php echo $lang_add_permissions_group; ?></button>
						</div>
						...
						<div class="col-lg-8">
							<div class="input-group">
								...
								<form action="<?php echo site_url('rolespermissions/permissions-group'); ?>" class="form-inline" method="get">
									<input type="text" class="form-control border-left-0"  name="q" value="<?php echo $q; ?>" placeholder="<?php echo $lang_search_permissions_group; ?>">
									<span class="input-group-append">									
										<button class="btn btn-light" type="submit"> <?php echo $lang_search; ?></button>
										<?php if ($q <> ''){?>
											<a href="<?php echo site_url('rolespermissions/permissions-group'); ?>" class="btn btn-light">Reset</a>
										<?php } ?>
									</span>
								</form>
							</div>										
					...
					<table class="table table-bordered table-togglable table-hover table-xs  ">
						...
						<?php foreach ($getpermissions_group_data as $getpermissions_group){?>
							<tr>
								...
								<td><i class="<?= $getpermissions_group->display_icon; ?>"></i> &nbsp;<?= $getpermissions_group->permissions_groupname; ?></td>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a data-toggle="modal" data-target="#modal_edit_permissions_group<?=$getpermissions_group->idpermissions_group;?>" class="dropdown-item"><i class="icon-pencil"></i><?php echo $lang_edit_permissions_group; ?></a>
										...
										<div class="row">
											<div class="col-sm-6">
												...
												<select name="status" class="form-control" required autocomplete="off">
													...
													<option <?php if ($getpermissions_group->status === '1') {echo 'selected="selected"';} ?> value="1"><?php echo $lang_active; ?></option>
													<option <?php if ($getpermissions_group->status === '0') {echo 'selected="selected"';} ?>value="0"><?php echo $lang_inactive; ?></option>
												</select>
											</div>
										</div>
									</div>
