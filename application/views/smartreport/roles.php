		...
		<!-- /page header -->                
				...
				<div class="card">
					...
					<div class="form-group row">
						<div class="col-lg-3">
							<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left" data-toggle="modal" data-target="#modal_add_roles"><b><i class="icon-key"></i></b> <?php echo $lang_add_roles; ?></button>
						</div>
						...
						<div class="col-lg-8">
							<div class="input-group">
								...
								<form action="<?php echo site_url('rolespermissions/roles'); ?>" class="form-inline" method="get">
									<input type="text" class="form-control border-left-0"  name="q" value="<?php echo $q; ?>" placeholder="<?php echo $lang_search_roles; ?>">
									<span class="input-group-append">									
										<button class="btn btn-light" type="submit"> <?php echo $lang_search; ?></button>
										<?php if ($q <> ''){?>
											<a href="<?php echo site_url('rolespermissions/roles'); ?>" class="btn btn-light">Reset</a>
										<?php } ?>
									</span>
								</form>
							</div>										
					...
					<table class="table table-bordered table-togglable table-hover table-xs ">
						...
						<?php foreach ($getroles_data as $getroles){?>
							<tr>
								...
								<?php } ?></td>
								<td>
									<a href="<?=base_url('rolespermissions/roles-permissions/').$getroles->idroles; ?>" class="btn btn-outline bg-brown border-brown text-brown-800 btn-icon"><i class="icon-equalizer"></i></a>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a data-toggle="modal" data-target="#modal_edit_roles<?=$getroles->idroles;?>" class="dropdown-item"><i class="icon-pencil"></i><?php echo $lang_edit_roles; ?></a>
										...
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<select name="status" class="form-control" required autocomplete="off">
													...
													<option <?php if ($getroles->status === '1') {echo 'selected="selected"';} ?> value="1"><?php echo $lang_active; ?></option>
													<option <?php if ($getroles->status === '0') {echo 'selected="selected"';} ?>value="0"><?php echo $lang_inactive; ?></option>
												</select>
											</div>
										</div>
									</div>
